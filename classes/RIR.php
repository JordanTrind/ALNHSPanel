<?php
    class RIR extends Database {
        ...
        protected $id, $timestamp, $driver, $driversteamid, $vehicle, $starttime, $endtime, $duration, $passenger1, $passenger1id, $passenger2, $passenger2id, $passenger3, $passenger3id;
        ...
        function setDriverSteamid($driversteamid) {
        ...
        function getDriverSteamid() {
            return $this->driversteamid;
        }
