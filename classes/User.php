<?php
    class User extends Database {
        ...
        protected $variable_defaultrows = array(
            array(
                'username' => "kasperbjerby",
                'passwordhash' => '$2y$10$BfvvrmPwOWomJLdSlTmHXu25pXZnPwnaAShOzTxd1.6jk7Bm0.3ZS',
                'name' => "Kasper Bjerby",
                'usergroup' => "1"
            )
        );
        ...
        protected $id, $username, $email, $passwordhash, $forgotId, $steamid, $ip, $mustchangepassword, $disabled, $usergroup = 2, $custompermissions, $lastlogin, $updated, $updated_by, $loginattempts, $created, $usertheme;
        ...
        public function GeneratePasswordHash($logout = true) {
            global $me;
            ...
            if(!empty($this->variable_password)) {
                ...
                // throw new Exception("Kodeord ikke sat");
            }
        ...
        public function hasPermission($permission, $customonly = false) {
            ...
            //$permissions = array_map('trim', array_filter(array_merge(explode(",", $this->custompermissions), explode(",", $usergroup->getPermissions()))));
