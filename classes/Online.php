<?php
    class Online extends Database {
        ...
        public function getOnlineStyled() {
            $online = $this->getOnline();

            if($online == 1) {
                return '<span class="btn btn-success nohover" title="Online - Last active: '.$this->getLastactive().'">Online</span>';
            } elseif($online == 2) {
                return '<span class="btn btn-warning nohover" title="Away - Last active: '.$this->getLastactive().'">Away</span>';
            }

            return '<span class="btn btn-danger nohover">Offline</span>';
        }

        public function getOnlineUsers() {
            return parent::getFromDB(NULL, NULL, 'result');
        }
    }
