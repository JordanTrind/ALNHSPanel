<?php
    class Log extends Database {
        ...
        protected $id, $reason, $message, $type, $timestamp, $ip, $browser, $os, $lang, $hostname;

        function __construct() {
            parent::__construct();
            parent::setupDatabase(tableName($this), $this->variable_database, $this->variable_defaultrows, false);
